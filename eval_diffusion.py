...
def parse_args_and_config():
    ...
    parser.add_argument("--config", type=str, default='lowlight.yml',
                        help="Path to the config file")
    
    parser.add_argument('--resume', default=r'/root/LLIE/MDMS-main/datasets/scratch/LLIE/ckpts/bestpsnr.pth.tar', type=str,
    ...
    parser.add_argument("--test_set", type=str, default='lowlight')
